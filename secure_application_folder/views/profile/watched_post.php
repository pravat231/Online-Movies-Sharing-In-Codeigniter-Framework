...
<div class="fav_date">Watched: <?php echo $row['watched_on']; ?></div>
<?php if($this->session->userdata('user_name')==$this->uri->segment(3)){ ?>
<div class="favs_deleted"><a href='<?php echo base_url(); ?>delfrmwatched/<?php echo $row['watched_id']; ?>' ref='delete_watched' name='delete'>Un-Watch it</a></div>
<?php } ?>
<div class="clearer"></div>
</div>
<?php $i++; if($i==5){ ?>
